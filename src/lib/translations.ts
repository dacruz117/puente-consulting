...
export const translations = {
  en: {
    ...
    collegeAdvising: {
      ...
      heroDescription:
        "Navigate the college admissions process with expert guidance every step of the way.",
      services: [
        {
  ...
  es: {
    ...
    collegeAdvising: {
      ...
      heroDescription:
        "Navega el proceso de admisi\u00f3n universitaria con orientaci\u00f3n experta en cada paso del camino.",
      services: [
        {
          title: "Estrategia de Selecci\u00f3n de Universidades",
          description:
            "Te ayudamos a identificar las universidades que mejor se adaptan a tu perfil acad\u00e9mico, intereses y metas.",
        },
        {
          title: "Revisi\u00f3n de Solicitudes",
          description:
            "Revisi\u00f3n y retroalimentaci\u00f3n integral de tus solicitudes universitarias para asegurar que destaquen.",
        },
        {
          title: "Asesor\u00eda para Ensayos",
          description:
            "Orientaci\u00f3n personalizada para redactar declaraciones personales y ensayos suplementarios convincentes.",
        },
        {
          title: "Orientaci\u00f3n sobre Ayuda Financiera",
          description:
            "Navega becas, solicitudes de ayuda financiera y estrategias de financiamiento para hacer la universidad m\u00e1s accesible.",
        },
      ],
      processSteps: [
        {
          ...
          description:
            "Comenzamos con una consulta gratuita para entender tus metas, historial acad\u00e9mico y lo que buscas en una experiencia universitaria.",
        },
        {
          step: 2,
          title: "Plan Personalizado",
          description:
            "Con base en nuestra conversaci\u00f3n, creamos un plan de asesor\u00eda personalizado con un cronograma, lista de universidades y pasos a seguir.",
        },
        {
          step: 3,
          title: "Ejecuci\u00f3n y Apoyo",
          description:
            "Trabajamos el plan juntos \u2014revisando solicitudes, refinando ensayos y prepar\u00e1ndote para cada etapa del proceso.",
        },
      ],
    },
    businessStartup: {
